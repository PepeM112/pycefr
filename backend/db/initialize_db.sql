-- Analysis
INSERT
    OR REPLACE INTO analyses (id, name, origin_id, total_hours, created_at)
VALUES (
        1,
        'pycefr_analysis',
        2,
...
-- Analysis Classes
INSERT
    OR REPLACE INTO analysis_class (analysis_id, class_id, instances)
VALUES (1, 7, 90);
INSERT
    OR REPLACE INTO analysis_class (analysis_id, class_id, instances)
VALUES (1, 8, 1);
...
-- Data
INSERT
    OR REPLACE INTO repo_general_info (
        analysis_id,
        name,
        url,
        description,
...
-- Commits
INSERT
    OR REPLACE INTO repo_commit_stats (
        analysis_id,
        name,
        github_user,
        loc,
...
-- Contributors
INSERT
    OR REPLACE INTO repo_contributors (
        analysis_id,
        name,
        github_user,
        avatar,
...
VALUES (
    ...
    (
        ...
        'gregoriorobles',
        'gregoriorobles',
        'https://avatars.githubusercontent.com/u/842692?v=4',
        'https://github.com/gregoriorobles',
        8
    );