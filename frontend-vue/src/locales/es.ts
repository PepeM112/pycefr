export default {
  ...
  analysis_rules: {
    ...
    async_await: 'Async: Expresión await',
    pattern_matching: 'Pattern Matching: match-case',
    type_hinting: 'Type Hinting: Anotaciones',
  },
  apply: 'Aceptar',
  ...
  error_during_analysis: 'Ocurrió un error durante el análisis.',
  ...
  repo: {
    ...
    search_contributors: 'Buscar contribuidores...',
    view_more: 'Ver más',
  },
